...
import SportsManagement from "./pages/Settings/SportsManagement";
import SponsorsManagement from "./pages/Settings/SponsorsManagement";
  ...
  return (
    <Routes>
      ...
      >
        ...
        />
        <Route
          path="settings/sponsors-management"
          element={
            <AdminRoute>
              <SponsorsManagement />
            </AdminRoute>
